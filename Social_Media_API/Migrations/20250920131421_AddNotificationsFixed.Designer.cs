...
namespace Social_Media_API.Migrations
{
    ...
    [Migration("20250920131421_AddNotificationsFixed")]
    partial class AddNotificationsFixed
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Social_Media_API.Model.Comment", b =>
                {
            ...
            modelBuilder.Entity("Social_Media_API.Model.Like", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Social_Media_API.Model.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Social_Media_API.Model.Comment", b =>
                {
                    b.HasOne("Social_Media_API.Model.Post", "Post")
                        .WithMany("Comments")
                        .HasForeignKey("PostId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Social_Media_API.Model.User", "User")
                        .WithMany("Comments")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Social_Media_API.Model.Friendship", b =>
                {
                    b.HasOne("Social_Media_API.Model.User", "Receiver")
                        .WithMany("FriendRequestsReceived")
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Social_Media_API.Model.User", "Requester")
